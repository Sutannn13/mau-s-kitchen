...
| FR-14 | Sistem membuat **ringkasan pesanan terstruktur** dan mengirimkannya ke WhatsApp admin via deeplink | P0 |
...
### US-06 — Mengirim pesanan ke WhatsApp

> **Sebagai** pelanggan,
> **saya ingin** pesanan saya otomatis terkirim rapi ke WhatsApp admin,
> **agar** tidak ada kesalahan pencatatan.

**Acceptance Criteria**
- [ ] Deeplink `https://wa.me/6281617691585?text=...` terbentuk dengan encoding benar
- [ ] Pesan memuat: kode pesanan, daftar item + varian + add-on + jumlah + subtotal, total, data pelanggan, metode bayar
- [ ] Emoji dan baris baru tetap rapi saat dibuka di WhatsApp
- [ ] Berfungsi di WhatsApp mobile maupun WhatsApp Web
...
| BR-05 | Ongkir ditentukan manual oleh admin sesuai jarak, dikonfirmasi lewat WhatsApp |
