    ...
    <main className="mx-auto w-full max-w-content px-4 pb-16 pt-6 md:px-8 md:pt-10">
      <div className="mx-auto max-w-2xl">
        ...
        {/*
          ...
          tipografi mono/serif + material kertas, animasi stagger halus via
          motion (lihat OrderReceiptDetails).
        */}
        ...
        <div className="mt-5 space-y-2.5">
          ...
          {isInvoiceAvailable(order.status) && totalFinal ? (
            <Link
              ...
              className="btn-press flex min-h-12 w-full items-center justify-center gap-2 rounded-full border border-gold/50 bg-cream-soft px-6 text-sm font-bold text-brown-deep transition-colors hover:bg-gold/15"
            >
              <ReceiptText aria-hidden="true" className="size-4" strokeWidth={2} />
              Lihat Invoice
            </Link>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="btn-press flex min-h-12 w-full items-center justify-center gap-2 rounded-full bg-success px-6 text-sm font-bold text-white shadow-warm transition-all hover:bg-success/90 hover:shadow-warm-lg"
          >
